...
ALLOWED_HOSTS=localhost,127.0.0.1,0.0.0.0  # Список разрешенных хостов
...
Миграции и сбор статики выполняются автоматически при запуске контейнера.
